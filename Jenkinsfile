    ...
    stage('Promoting release v5.1') {
      ...
      stages {
        stage('Generating release') {
          steps {
            sh 'docker tag registry.sonata-nfv.eu:5000/tng-gtk-common:latest registry.sonata-nfv.eu:5000/tng-gtk-common:v5.1'
            sh 'docker tag registry.sonata-nfv.eu:5000/tng-gtk-common:latest sonatanfv/tng-gtk-common:v5.1'
            sh 'docker push registry.sonata-nfv.eu:5000/tng-gtk-common:v5.1'
            sh 'docker push sonatanfv/tng-gtk-common:v5.1'
          }
        }
      }
    }
